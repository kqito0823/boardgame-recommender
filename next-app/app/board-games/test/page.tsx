...
const initialGames = [
  {
    ...
    name: "オセロ",
    players: "2",
    description: "自分の色が多い方が勝ち...",
    isFavorite: true,
    playCount: 10,
    lastPlayed: "2025/10/2",
  },
  {
    id: 2,
    name: "チェス",
    players: "2",
    description: "戦略ゲームの定番",
    isFavorite: false,
    playCount: 2,
    lastPlayed: "2025/10/1",
  },
  {
    id: 3,
    name: "麻雀",
    players: "4",
    description: "4人で遊ぶテーブルゲームの定番",
    isFavorite: false,
    playCount: 1,
...
// 保有ゲーム管理画面コンポーネント
export default function ManagePage({ games }) {
